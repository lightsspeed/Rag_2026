...
import { getRagMetrics, getDocuments, uploadDocument, deleteDocument, type KBDocument } from "@/services/api";
        ...
        <CardContent>
          {documents.length === 0 ? (
            ...
            <div className="space-y-1">
              {documents.map((doc) => (
                <div key={doc.id} className="flex items-center justify-between p-3 rounded-lg hover:bg-secondary/30 transition-colors">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="flex items-center gap-2 text-[10px] text-muted-foreground">
                        ...
                        <Badge variant="outline" className={cn("text-[9px] px-1",
                          doc.status === "completed" ? "text-green-600 border-green-500/30" :
                          doc.status === "failed" ? "text-destructive border-destructive/30" :
